...
package kat.browser.lightning.activity;
...
import kat.browser.lightning.browser.BookmarksView;
import kat.browser.lightning.browser.BrowserPresenter;
import kat.browser.lightning.browser.BrowserView;
import kat.browser.lightning.browser.TabsView;
import kat.browser.lightning.bus.BookmarkEvents;
...
import kat.browser.lightning.pie.PieControl;
import kat.browser.lightning.controller.UIController;
import kat.browser.lightning.database.BookmarkManager;
import kat.browser.lightning.database.HistoryDatabase;
...
import kat.browser.lightning.interpolator.BezierDecelerateInterpolator;
import kat.browser.lightning.receiver.NetworkReceiver;
import kat.browser.lightning.search.SuggestionsAdapter;
import kat.browser.lightning.utils.DrawableUtils;
import kat.browser.lightning.utils.ProxyUtils;
import kat.browser.lightning.utils.ThemeUtils;
import kat.browser.lightning.utils.UrlUtils;
import kat.browser.lightning.utils.Utils;
import kat.browser.lightning.utils.WebUtils;
import kat.browser.lightning.view.Handlers;
import kat.browser.lightning.view.LightningView;
import kat.browser.lightning.view.SearchView;
...
//        mBrowserFrame.setLayoutTransition(new LayoutTransition());
    ...
    private final Object mBusEventListener = new Object() {
         ...
         * {@link kat.browser.lightning.fragment.BookmarksFragment} and by the
